                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($laporan['status'] == "Menunggu Konfirmasi") : ?>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-warning" onclick="document.getElementById('statusForm').submit();">
                                                                            Ya, Selesaikan
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <!-- Form -->
                                                        <form id="statusForm" method="POST" action="<?= site_url('service/updateStatusInAction') ?>" style="display: none;">
